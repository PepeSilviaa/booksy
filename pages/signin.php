...
if(isset($_POST['userinput'])){
  ...
  $endp = "http://rmcgrath13.lampt.eeecs.qub.ac.uk/booksy/secureapi/secure.php";
  ...
  //print_r($opts);
      ...
      //echo gettype($result); // type checker
      //echo $result;
  ...
  <form action = "signin.php" method = "POST" name = "login">
    ...
    <div class="field is-grouped">
      <div class="control login-button">
        <button class="button login-button" input type= "submit" value = "send info" class= "form full" name="userinput">Login</button>
      </div>
      </form>
